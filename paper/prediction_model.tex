...
We define and use  \textsc{C} with the help of the logistic regression function for the specific purpose of our study. 
% Logistic regession function
\subsection{Logistic regression}
The logistic regression (also known as the logit function) is a statistical model for binary classification which, in its basic form, is based on
 a logistic function to represent a binary dependent variable.
