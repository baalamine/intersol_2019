...
recall, F-measure, sensitivity and specificity of the predicted classes. We have also drawn the graph of the Receiver operating 
characteristic of the logistic regression to study its shape.  
The sensitivity and specificity are often used in the medecine domain as performance measures for prediction tasks.
