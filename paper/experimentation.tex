...
\item \textbf{n\_jobs}: number of cpu cores used when parallelizing over classes if multi\_class='ovr'. This parameter is ignored when the
solver is  set to 'liblinear' regardless whether 'multiclass' is specified or not.
